...
for i, distance in ipairs(distances) do
    ...
    if #circuits == 1 and #(circuits[1]) == #jBoxes then
        print('All junction boxes in a single circuit')
        print(jBoxes[distance[2]][1] * jBoxes[distance[3]][1], 'The multiplied distance of the final connected boxes')
        break
    end
end
